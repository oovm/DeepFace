...
params = Import@"karras2018iclr-celebahq-1024x1024.mx";
...
leakyReLU[alpha_]:=LeakyReLU[alpha];
...
mainNet = NetChain[{
	$pre,(*ReshapeLayer[{512,1,1}],*)
	$part1,(*I can't understand how to calc wScale*)
	...
	getOut[1024, 16](*ResizeLayer[Scaled/@{1/3,1/3}]*)
},
	"Input" -> 512,
	"Output" -> "Image"
]
...
sign=StringTake[Hash[mainNet,"Expression","HexString"],6]
NetSave[mainNet,"PGGAN_CelebA"];
